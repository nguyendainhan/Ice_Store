<template>
    <nav class="nav-container">
        ...
        <!-- Logo -->
        <div class="logo">
            <router-link to="/" class="logo-text">IceStore</router-link>
        </div>
        ...
        <div class="sidebar" :class="{ active: isMenuOpen }">
            ...
            <div class="menu">
                ...
                <router-link to="/members" @click="isMenuOpen = false">Members</router-link>
                <router-link to="/rules" @click="isMenuOpen = false">Rules</router-link>
            ...
            <div class="auth-section">
                ...
                <router-link to="/register" class="btn-register" @click="isMenuOpen = false">
                    Register
                </router-link>
            </div>
        </div>
